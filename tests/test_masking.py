...
from jax import vmap, jit, grad, make_jaxpr
from jax_masking import mask, shapecheck
from jax_masking.masking import (
  shape_as_value, ShapeError, parse_spec, Poly, Mon, finalize_spec,
  eval_poly_shape, remap_ids, UniqueIds, UndefinedPoly)
...
class MaskingTest(jtu.JaxTestCase):
  ...
  @parameterized.named_parameters(cases_from_list(
